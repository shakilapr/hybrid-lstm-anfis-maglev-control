...
**Issue 1: "No files matching pattern found"**
- **Cause**: Data files not in `data/` folder or wrong naming
- **Solution**: Ensure files are named `output_*.csv` (e.g., `output_1.csv`)

**Issue 2: "Out of memory" during LSTM training**
- **Cause**: Large dataset or insufficient RAM
- **Solution**: Reduce sequence length or mini-batch size in Section 6

**Issue 3: ANFIS training error**
- **Cause**: Data range mismatch with membership functions
- **Solution**: Check data clipping ranges in Section 3

**Issue 4: Poor model performance**
- **Cause**: Insufficient training data or noisy signals
- **Solution**: Collect more data, adjust clipping ranges, or tune hyperparameters

### Performance Optimization

**For Faster Training**:
- Reduce LSTM epochs (200 → 100)
- Decrease mini-batch size (32 → 16)
- Use GPU acceleration (MATLAB Parallel Computing Toolbox)

**For Better Accuracy**:
- Increase ANFIS membership functions
- Extend LSTM sequence length (10 → 20)
- Add more training epochs with validation patience

## Contributing

This is a research project repository. Contributions, suggestions, and discussions are welcome!
...
```bibtex
@software{rathnayake2024hybrid,
  author = {Rathnayake, Shakila Praveen},
  title = {Hybrid LSTM-ANFIS Control System for Magnetic Levitation},
  year = {2024},
  publisher = {GitHub},
  url = {https://github.com/shakilapr/hybrid-lstm-anfis-maglev-control},
  note = {A comprehensive implementation combining LSTM neural networks and ANFIS for magnetic levitation control}
}
```

### Related Publications
If you publish work using this code, please also reference:
- Original ANFIS paper: Jang (1993) - "ANFIS: Adaptive-Network-Based Fuzzy Inference System"
- LSTM fundamentals: Hochreiter & Schmidhuber (1997) - "Long Short-Term Memory"

## Acknowledgments

This implementation was developed as part of a magnetic levitation control system research project at the Mechatronics Engineering Department. The work demonstrates the practical integration of modern deep learning techniques (LSTM) with traditional fuzzy control methods (ANFIS) for advanced control applications.

**Special Thanks**:
- MATLAB Deep Learning and Fuzzy Logic Toolbox teams for excellent documentation
- Research community for open-source implementations and discussions

## Project Status

| Component | Status | Notes |
|-----------|--------|-------|
| **Implementation** | ✅ Complete | All 7 sections functional |
| **Documentation** | ✅ Complete | README, code comments, data guide |
| **Testing** | ✅ Complete | Validated on maglev system data |
| **Deployment** | ✅ Ready | Trained models saved and reusable |
